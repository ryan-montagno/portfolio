...
const Sidenav = () => {
  ...
  return (
    <div className=''>
        <AiOutlineMenu onClick={(handleNav)} className='fixed top-4 right-4 z-[99] md:hidden cursor-pointer' />
        {
            nav ? (
        ...
        <div className='md:block hidden fixed top-[25%] z-10'>
            <div className='flex flex-col'>
                {/*Home*/}
                <a href='#main' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duaration-300'>
                    <AiOutlineHome size={20}/>
                </a>
                {/*Work*/}
                <a href='#about' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duaration-300'>
                    <GrProjects size={20}/>
                </a>
                {/*Projects*/}
                <a href='#projects' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duaration-300'>
                    <AiOutlineProject size={20}/>
                </a>
                {/*Contact*/}
                <a href='#contact' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duaration-300'>
                    <AiOutlineMail size={20}/>
                </a>
            </div>
        </div>
